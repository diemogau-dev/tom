...
2. **Logos de clientes** — en `index.html`, buscá el comentario `<!-- LOGOS CLIENTES -->`. Hoy hay cajas con nombres. Cuando tengas los archivos de logo, reemplazá esas cajas por `<img>`.
3. **Testimonios y casos** — los slots están maquetados pero vacíos, con el comentario `PENDIENTE: contenido real`.
